...
products = [
    ...
    {"name": "Coffee Maker", "desc": "Brew fresh coffee", "price": "89.99", "cat": "Home", "stock": 20, "img": "https://images.unsplash.com/photo-1495474472205-16284eb4308c?w=500&auto=format&fit=crop&q=60", "features": {"Color": ["Black", "Silver", "Red"]}},
    {"name": "Desk Lamp", "desc": "LED lamp", "price": "29.99", "cat": "Home", "stock": 40, "img": "https://images.unsplash.com/photo-1513506003901-1e6a22d15?w=500&auto=format&fit=crop&q=60", "features": {"Lighting": ["Warm", "Cool", "Neutral"]}},
    {"name": "Sci-Fi Novel", "desc": "Space adventure", "price": "14.99", "cat": "Books", "stock": 60, "img": "https://images.unsplash.com/photo-1476275466078-4007374efac4?w=500&auto=format&fit=crop&q=60", "features": {"Format": ["Paperback", "Hardcover", "Audiobook"]}}
]
